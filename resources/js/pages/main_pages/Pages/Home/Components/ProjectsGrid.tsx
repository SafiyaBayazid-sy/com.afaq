                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-background-dark shadow-lg hover:shadow-2xl transition-all border border-slate-100 dark:border-primary/20 flex flex-col text-right">
                        <div className="aspect-[16/10] overflow-hidden">
                            <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCYqavgjO6WUWWiQ4eCHT_bHpOFcmmlzGVldvu_h7p9koPGfRwD9W1LUXRPYAZcE8MmoyjTyaLerJvmVpDTe4ma6xB6PsM_ywUr4QBEd5wDxm1Ykzsvy7jMyGHTP7vbr2zk0qbWAMaM5UlitWPate8-KRSLTo7z25CcZvo28ZHWiC4tcEwe-AazhMJ2dz-6l5omiNyvw6wkPL_RmyjJJRUCBsJwXDP_9-VlEgeNvlztEAbXLWdgtFdT_S6dz7y9V6ISjaUbWgZrFQkn" alt="Luxury villa" />
                        </div>
                        <div className="p-6">
                            ...
                            <p className="text-slate-500 text-sm mb-4 line-clamp-2">فلل سكنية فاخرة بتصاميم عصرية توفر أقصى درجات الخصوصية والراحة لعائلتك.</p>
                    ...
                    {/* Project 2 */}
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-slate-500 text-sm mb-4 line-clamp-2">بيئة عمل متكاملة للمكاتب والشركات الناشئة في قلب المنطقة المركزية.</p>
                            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-primary/10">
                                <div className="flex items-center gap-2 text-slate-400 text-sm">
                                    <span className="material-symbols-outlined text-sm">location_on</span>
                                    <span>جدة</span>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-background-dark shadow-lg hover:shadow-2xl transition-all border border-slate-100 dark:border-primary/20 flex flex-col text-right">
                        <div className="aspect-[16/10] overflow-hidden">
                            <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAUgSSg-7rKt8xbGt-r3ZM7C8R6TfwwQrThzjqGSf_BBCOAIgAfe9SJygjIdbHtN5ffpzFBVF4fRuS_2gZIRiRIAt45o8o9MPQw9So1KTiBAfjNBM3k4ghoqHVxDT_tOHgMn02KaWHuiwr8vbl4q9SY19hCfh2pxK5-kAfIhBQ5J1KvV9ydfg32dtGHjMiE3fO6LBpBmlzmutqETT9zAKrufNGIvJPt7ADeHT5TCxXsCl2DWg0C_e2n5OAEPxeJEDmik4HYPYkHe4KY" alt="Resort" />
                        </div>
                        <div className="p-6">
                            ...
                            <p className="text-slate-500 text-sm mb-4 line-clamp-2">تجربة حياة فريدة تجمع بين الرفاهية والمرافق الترفيهية المتكاملة.</p>
                            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-primary/10">
                                <div className="flex items-center gap-2 text-slate-400 text-sm">
                                    <span className="material-symbols-outlined text-sm">location_on</span>
                                    <span>الدمام</span>
